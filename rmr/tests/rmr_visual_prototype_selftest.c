...
int main(void) {
    ...
    CHECK(dog_match.best_view_id == RMR_VISUAL_VIEW_FRONT);
    ...
    CHECK(written == RmR_VisualPrototype_SerializedSize(&dog));
    ...
    CHECK(restored.prototype_crc32c == dog.prototype_crc32c);
