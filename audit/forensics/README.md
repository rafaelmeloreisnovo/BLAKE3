...
| [`../receipts/BLAKE3_FACTUAL_DOSSIER_INTEGRATION_SUCCESSOR_V1_20260925.txt`](../receipts/BLAKE3_FACTUAL_DOSSIER_INTEGRATION_SUCCESSOR_V1_20260925.txt) | Successor receipt da integração: preserva o blob do dossiê e registra a reancoragem da branch no master mais novo sem mutação de conteúdo. |
