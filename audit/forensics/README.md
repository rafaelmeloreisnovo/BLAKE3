...
| [`BLAKE3_FACTUAL_DOSSIER_MAINTENANCE_NETWORK_V1_20260924.md`](BLAKE3_FACTUAL_DOSSIER_MAINTENANCE_NETWORK_V1_20260924.md) | Dossiê narrativo factual sobre atividade de integração/moderação observada, security wording entre coautores, rede pública de referências, inputs externos e limites de inferência. |
| [`BLAKE3_FACTUAL_DOSSIER_EVIDENCE_MATRIX_V1_20260924.tsv`](BLAKE3_FACTUAL_DOSSIER_EVIDENCE_MATRIX_V1_20260924.tsv) | Matriz de evidências do dossiê com objeto-fonte, atores, fato, âncora e estado. |
| [`../receipts/BLAKE3_FACTUAL_DOSSIER_RECEIPT_V1_20260924.txt`](../receipts/BLAKE3_FACTUAL_DOSSIER_RECEIPT_V1_20260924.txt) | Receipt que liga o dossiê aos blobs GitHub e às revisões dos documentos antecedentes no Drive. |
| [`../receipts/BLAKE3_FACTUAL_DOSSIER_REBASE_RECEIPT_V1_20260924.txt`](../receipts/BLAKE3_FACTUAL_DOSSIER_REBASE_RECEIPT_V1_20260924.txt) | Receipt de sucessão #156→#157, preservando blobs do dossiê/matriz e registrando a nova base do master. |
| [`BLAKE3_DOSSIE_FACTUAL_GOVERNANCA_REFERENCIAS_V1_20260924.md`](BLAKE3_DOSSIE_FACTUAL_GOVERNANCA_REFERENCIAS_V1_20260924.md) | Dossiê narrativo factual: concentração observada de integração/moderação, security wording público entre coautores, rede pública de referências, collision/security threads e closed-PR succession, sem imputação de motivo. |
| [`../receipts/BLAKE3_DOSSIE_FACTUAL_GOVERNANCA_RECEIPT_V1_20260924.txt`](../receipts/BLAKE3_DOSSIE_FACTUAL_GOVERNANCA_RECEIPT_V1_20260924.txt) | Receipt que liga o dossiê aos predecessores GitHub e aos documentos/revisões canônicas do Drive. |
